...
- Cleanup track:
  ...
  - [x] `P3-W2` decide and document the intended owner for lifecycle persistence versus channel-specific persistence edges (done 2026-03-11; plan: `docs/plans/2026-03-11-p3-w2-lifecycle-channel-persistence-ownership.md`)
