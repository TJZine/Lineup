...
export const EPG_CLASSES = {
    ...
    CHANNEL_NAME_PRIMARY: 'epg-channel-name-primary',
    CHANNEL_NAME_PROVENANCE: 'epg-channel-name-provenance',
    CHANNEL_NAME_SOURCE: 'epg-channel-name-source',
    CHANNEL_NAME_CATEGORY: 'epg-channel-name-category',
    CHANNEL_NAME_SEPARATOR: 'epg-channel-name-separator',
    ...
    CELL_TITLE_TEXT: 'epg-cell-title-text',
    ...
    CELL_SUBTITLE_TEXT: 'epg-cell-subtitle-text',
    CELL_SUBTITLE_TICKER_READY: 'epg-cell-subtitle-ticker-ready',
    CELL_SUBTITLE_TICKER_RUNNING: 'epg-cell-subtitle-ticker-running',
