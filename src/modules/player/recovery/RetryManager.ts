import type { StreamDescriptor, PlaybackError } from '../core/types';
import { MAX_RETRY_ATTEMPTS, RETRY_BASE_DELAY_MS, SYNTHETIC_MEDIA_ERROR_CODE_KEY } from '../core/constants';
