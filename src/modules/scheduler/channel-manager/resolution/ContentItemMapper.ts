import type { PlexMediaItemMinimal } from '../contracts/interfaces';
...
type PlexStreamMinimal = NonNullable<
    NonNullable<
        NonNullable<PlexMediaItemMinimal['media']>[number]['parts']
    >[number]['streams']
>[number];
...
export class ContentItemMapper {
    toResolvedItem(item: PlexMediaItemMinimal, index: number): ResolvedContentItem {
    ...
    private _selectAudioStream(streams: PlexStreamMinimal[]): PlexStreamMinimal | undefined {
