...
9. [`src/App.ts`](../../src/App.ts)
10. [`src/core/app-shell/AppContainerFactory.ts`](../../src/core/app-shell/AppContainerFactory.ts)
11. [`src/core/app-shell/AppBlockingErrorOverlayPresenter.ts`](../../src/core/app-shell/AppBlockingErrorOverlayPresenter.ts)
12. [`src/modules/ui/audio-setup/AudioSetupScreen.ts`](../../src/modules/ui/audio-setup/AudioSetupScreen.ts)
13. [`src/modules/ui/splash/SplashScreen.ts`](../../src/modules/ui/splash/SplashScreen.ts)
14. [`src/modules/ui/now-playing-info/constants.ts`](../../src/modules/ui/now-playing-info/constants.ts)
15. [`src/modules/ui/playback-options/constants.ts`](../../src/modules/ui/playback-options/constants.ts)
16. [`src/__tests__/fixtures/appShellContainerIds.ts`](../../src/__tests__/fixtures/appShellContainerIds.ts)
