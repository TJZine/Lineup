...
- **Pre-MVP path policy**: Until an explicit milestone is reached (e.g., MVP launch) or explicitly requested, do not add legacy/fallback/compatibility code paths, migration shims, or dual-path "just in case" logic.
