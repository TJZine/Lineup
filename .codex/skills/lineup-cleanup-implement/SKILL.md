...
This skill is the skill-based replacement for the legacy prompt file `/Users/tristan/.codex/prompts/lineup-cleanup-implement.md`.
...
4. `/Users/tristan/Software/Lineup/docs/agentic/session-prompts/cleanup-implement.md`
